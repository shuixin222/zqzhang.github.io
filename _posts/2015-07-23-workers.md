...
> From July 2014 till now Xiang contributed 45 CLs to Chromium. The important features and enhancements contributed by Xiang includes:
> * skipWaiting() and claim() support to enable worker explicitly acquire page control
> * .ready promise refator to support complicate registration scenarios
> * new ServiceWorkerMessageEvent/ExtendableMessageEvent interfaces implementation
> * worker process management optimization which reduced worker process overhead
